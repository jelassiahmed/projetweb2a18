...
<body>
    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between light left">
            ...
            <nav class="classy-navbar" id="essenceNav">
                <!-- Logo -->
                <a class="nav-brand" href="shop.php"><img src="img/core-img/M&A.png" alt=""></a>
                <!-- Navbar Toggler -->
                            ...
                            <li class="megamenu-item"><a href="#">Chaussures</a>
                                <div class="megamenu">
                                    <ul class="single-mega cn-col-4">
                                        ...
                                        <li><a href="shop.php">Basckets</a></li>
                                        <li><a href="shop.php">Bottes</a></li>
                                        <li><a href="shop.php">Sandales</a></li>
            ...
            <div class="header-meta d-flex clearfix justify-content-end">
                ...
                <div class="search-area">
                    <form action="shoprech.php" method="post">
    ...
    <div class="breadcumb_area bg-img" style="background-image: url(../M&A/img/i.jpg);">
                            ...
                            <div class="col-12">
                                <div class="product-topbar d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="total-products">
                                        <p><span></span> Produits trouvés : </p>
                                    </div>
                                    <!-- Sorting -->
                                        
                                            <select id="sortByselect" name="select" onchange="location = this.value;" >

                                            <option value="shopasc.php">Prix: $ - $$</option>
...
$sql="SELECT * from produit where marque like '%".$_POST['search']."%' ";
                ...
                <div class="col-12 col-md-6">
                    <div class="single_widget_area d-flex mb-30">
                        ...
                        <div class="footer-logo mr-50">
                            <a href="#"><img src="img/core-img/1.jpg" alt=""></a>
                        </div>
                        <!-- Footer Menu -->
