...
$sql2="SELECT COUNT('marque') from produit";
...
<body>
    ...
    <header class="header_area">
        <div class="classy-nav-container breakpoint-off d-flex align-items-center justify-content-between light left">
            ...
            <nav class="classy-navbar" id="essenceNav">
                ...
                <a class="nav-brand" href="index.html"><img src="img/core-img/1.JPG" alt=""></a>
                <!-- Navbar Toggler -->
                    ...
                    <div class="classynav">
                        <ul>
                          <li><a href="index.html">Acceuil</a></li>
                            <li class="megamenu-item"><a href="#">Chaussures</a>
                                <div class="megamenu">
                                    <ul class="single-mega cn-col-4">
                                        <li class="title">Femme Collection</li>
                                        <li><a href="shop.php">Tout Afficher</a></li>
                                        <li><a href="shop.html">bottes</a></li>
                                        <li><a href="shop.html">Basckets</a></li>
                                        <li><a href="shop.html">Sandales</a></li>
                                        
                                    </ul>
                                   <!-- <ul class="single-mega cn-col-4">
                                        <li class="title">Homme Collection</li>
                                        <li><a href="shop.html">Tout Afficher</a></li>
    ...
    <div class="right-side-cart-area">
        ...
        <div class="cart-content d-flex">
            ...
            <div class="cart-list">
                ...
                <div class="single-cart-item">
                    <a href="#" class="product-image">
                        <img src="img/product-img/1.jpg" class="cart-thumb" alt="">
                        <!-- Cart Item Desc -->
                        <div class="cart-item-desc">
                          <span class="product-remove"><i class="fa fa-close" aria-hidden="true"></i></span>
                            <span class="badge">Mango</span>
    ...
    <div class="breadcumb_area bg-img" style="background-image: url(../M&A/img/IMG_1189.jpg);">
    ...
    <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-wrapper">
                                    ...
                                    <div class="product-img">
                                        <img src="../M&A/img/<?php echo $row['img']; ?>" alt="">
                                        <!-- Hover Thumb -->
                                        <img class="hover-img" src="../M&A/img/<?php echo $row['img']; ?>" alt="">
